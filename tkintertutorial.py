...
if __name__ == '__main__':
    root = tk.Tk()
    style = ttk.Style()
    gauge = OrientDisplay(root, padding = 20)
    root.resizable(False,False)
    root.title("Orient Gauge")
    gauge.pack()
    ttk.Scale(root, from_=90, to=270, variable=gauge.arcvariable).pack(fill='x', padx=10, pady=10)
    #btn = Button(root, text = 'Click me !', bd = '5', command = gauge.update_arcvariable()).pack()
